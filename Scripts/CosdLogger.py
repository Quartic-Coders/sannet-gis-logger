...
class CosdLogger:
    ...
    def __init__(self, directory = "", name = ""):
        ...
        self.file_name = self.__getCallingName() if (name == "") else name # assign file name to name of caller if bank     
        self.directory = os.path.dirname(os.path.realpath(__file__)) if (directory == "") else directory # assign dir to dir of caller if blank 
...
if __name__== "__main__":
    cosdlogger = CosdLogger() # initialize logger
    cosdlogger.log("test message") # test log output